...
const MainSlider = () => {
  ...
  className='mainSlider h-full bg-primary xl:bg:-mainSlider 
  xl:bg-no-repeat max-w--lg lg:max-w-none rounded-[8px] 
      ...
      <SwiperSlide key={index}>
        <div className='flex flex-col lg:flex-row h-full p-[20px] md:p-[60px]'>
          <div className='w-full lg:flex-1'>
            ...
            <div className='text-31 md:text-[46px] front-semibold
