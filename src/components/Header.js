...
const Header = () => {
  ...
  xl:mb-[30px]'>
    <div className='container mx-auto'>
      ...
      mb-4 xl:mb-0'>
       <div onClick={() => setCatnavMobile(true)}
       ...
       <Link to={'/'}> 
         ...
         alt=''
       /></Link>
        <div className='hiddem w-full xl:flex xl:max-w-[734px]'>
          <SearchForm />
        </div>
        <div className='flex items-centergap-x-[10px]'>
         <div className='hidden xl:flex uppercase'>Need help?  6378915656</div>
         <div
           onClick={()=>setIsOpen(!isOpen)} 
           className='relative cursor-pointer'>
          <SlBag className='text-2xl' />
           <div className='bg-accent text-primary absolute w-[18px]
        ...
        <div 
          ...
          bg-[#0e0f10] shado-xl fixed top-0 bottom-0 w-full
